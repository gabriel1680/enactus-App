    ...
    <nav class="nav-sidebar">
        ...
        <div class="menu">
            <ul>
                ...
                <a href="<?= url("/eventos"); ?>" class="item-link">
                    <li class="menu-item">Eventos</li>
                </a>
                <a href="<?= url('/presenca'); ?>" class="item-link">
                    <li class="menu-item">Presença</li>
                </a>
                <a href="<?= url('/usuarios'); ?>" class="item-link">
                    <li class="menu-item">Membros</li>
                </a>
